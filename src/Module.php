...
/**
 * This is the main module class for the Rbac module.
 *
 * To use Rbac, include it as a module in the application configuration like the following:
 *
 * ~~~
 * return [
 *     'modules' => [
 *         'rbac' => ['class' => 'harrydingding\rbac\Module'],
 *     ],
 * ]
 * ~~~
 *
